                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (!dataSnapshot.hasChildren()) {
                                new MaterialDialog.Builder(LoginActivity.this)
                                        ...
                                        .cancelable(true)
                                        .content("Would you to personalize your Profile on The Pet Store?. Click \"Complete Now\" to do it now. Or, click \"Later\" to complete your Profile later")
                                        .positiveText("Complete Now")
                                        .negativeText("Later")
                                        .theme(Theme.LIGHT)
                                        ...
                                        .onPositive(new MaterialDialog.SingleButtonCallback() {
                                            ...
                                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                                Intent showProfileCreator = new Intent(LoginActivity.this, ProfileCreatorActivity.class);
                                        ...
                                        .onNegative(new MaterialDialog.SingleButtonCallback() {
                                            @Override
                                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                                Intent showLanding = new Intent(LoginActivity.this, TestMainLandingActivity.class);
